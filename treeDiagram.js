...
/*This function instatiates the grpah*/

function init(){
var $ = go.GraphObject.make;  // for conciseness in defining templates

     courseGraph =
       $(go.Diagram, "courseGraph",  // must be the ID or reference to div
         {
     ...
     courseGraph.model = new go.TreeModel(nodeDataArray);

     document.getElementById('zoomToFit').addEventListener('click', function() {
       courseGraph.commandHandler.zoomToFit();
     });

     document.getElementById('centerRoot').addEventListener('click', function() {
       courseGraph.scale = 1;
       courseGraph.scrollToRect(courseGraph.findNodeForKey(0).actualBounds);
     });
